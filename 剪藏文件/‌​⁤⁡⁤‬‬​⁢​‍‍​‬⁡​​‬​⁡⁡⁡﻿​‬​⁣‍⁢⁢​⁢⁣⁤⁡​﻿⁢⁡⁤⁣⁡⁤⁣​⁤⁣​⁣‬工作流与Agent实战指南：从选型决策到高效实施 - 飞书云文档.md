---
标题: "‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档"
链接: "https://waytoagi.feishu.cn/wiki/H6pLw1rjUiQtdqkg8LVcjlUNnah"
作者:
创建时间: 2025-11-30T20:46:26+08:00
摘要:
tags:
  - "clippings"
字数: 84
...
> 🔗 原文链接： https://mp.weixin.qq.com/s/tdOV-j07jqcyaSJGaLbukA
> 
> ⏰ 发布时间： 2025年04月19日 10:03(UTC+8)
> 
> 作者：晏明AI
...
[硅基世界指北的「说明书」](https://g2rfwon688.feishu.cn/docx/OAeQdlk40o1uwnxsaAHczAA6nvz?from=from_copylink)

# 本文价值

本文从Anthropic的文章《Building effective agents》出发，为构建高效的工作流、Agent提出实战指南。我在保留原文精华的基础上增强了三个核心方面：

![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/da5b6ebe290f88374892e19f93165cdf_MD5.jpg]]

1. **技术选型指南**：明确工作流/Agent选用标准。
    
2. **设计模式解析**：通过实际业务场景展示复杂工作流模式的应用。
    
3. **践要点扩展**：增添详细的实施建议和操作要点，将理论转化为可执行方案。
    

本文适合AI Agent爱好者、产品经理、开发者及技术管理者阅读，通过实践层面的指导，帮您实现更合理的方案与更高效的实施

![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/5c9382dff0c6b9468c2bfd282956c6f5_MD5.jpg]]
...
Anthropic强烈建议：**在构建LLM应用时，寻找尽可能简单的解决方案，**_**只在**_**必要时增加应用复杂性**。
...
参考Anthropic的[cookbook](https://github.com/anthropics/anthropic-cookbook/tree/main/patterns/agents)获取示例实现。
...
![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/26c933245d185ceb38de300bd59ba7ef_MD5.jpg]]
...
虽然实现这些增强功能的方法很多，一种推荐方式是通过Anthropic最近发布的[模型上下文协议(MCP)](https://www.anthropic.com/news/model-context-protocol)，该协议允许开发者通过简单的客户端实现与不断扩展的第三方工具生态系统集成。
...
![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/f4c8e8f0b6c3fa5e7c039a972dbccd30_MD5.jpg]]
...
![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/bc7f0106f4eba2721c6c36bc77e09df0_MD5.jpg]]
...
![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/4b4420abefbc7320ca7db97a675bb09d_MD5.jpg]]
...
- **投票（Voting）**
    ...
    - **政治表达**：高阈值（宽容度高）
        ...
        1. 提示4为"是"且提示1、2不为"是"→允许内容
            
        2. 理由：保护合法政治表达，避免过度审查
    ...
    - **并行评估结果**：
        ...
        1. 提示1（暴力）："是"（提到"扔进海里喂鲨鱼"）
            
        2. 提示2（仇恨）："否"（针对政客非受保护群体）
            
        3. 提示3（不文明）："是"（使用"垃圾"等贬义词）
...
![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/f48d575191fad6d0c621131f21c78be2_MD5.jpg]]
...
- 与并行化的关键区别在于**灵活性**——子任务不是预定义的，而是由编排者根据任务输入动态确定
...
   **搜索计划**： 1. 识别关键搜索术语和相关概念 2. 确定需要搜索的最佳来源 3. 为每个来源设计特定搜索策略 4. 分配多名工作者执行不同来源的搜索 5. 汇总和综合所有发现的信息 6. 确定是否需要进一步搜索 7. 准备最终报告
...
![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/287259d5935187115651a0e2fc8a8b7c_MD5.jpg]]
...
![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/e33151b0bc799d9a9e754cceb9645081_MD5.jpg]]
...
- **编程Agent**：解决[SWE-bench任务](https://www.anthropic.com/research/swe-bench-sonnet)，根据任务描述对多个文件进行编辑
    
- **计算机使用Agent**：[computer use](https://github.com/anthropics/anthropic-quickstarts/tree/main/computer-use-demo)，Claude使用计算机完成复杂任务
    

![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/2852c13656e7757c6b4cac036e7d8d94_MD5.jpg]]
...
1. **提示链 + 路由：**
    ...
    1. **机制**：路由分类任务，然后应用专用提示链
        
    2. **示例：**客服系统先分类问题(账单/技术/退款)，再应用对应专业处理链。
        
2. **路由 + 并行化：**
    
    1. **机制**：先分类任务，对特定类别应用并行处理
        
    2. **示例：**内容审核系统分类内容后，对复杂案例启用多评估者并行投票。
        
3. **编排者-工作者 + 评估者-优化者：**
    
    1. **机制**：编排者分解分配任务，工作者执行，评估者提供反馈优化
        
    2. **示例：**代码系统中编排者确定修改文件，工作者生成代码，评估者检查提供改进建议
        
4. **提示链 + 评估者-优化者：**
    
    1. **机制**：在提示链关键节点使用评估-优化循环提升质量
        
    2. **示例**：内容创作流程生成大纲→细化大纲→基于大纲创作→评估优化
        
5. **混合Agent系统：**
    
    1. **机制**：整合多种模式，不同任务阶段使用最适合的模式
        
    2. **示例**：全功能客服Agent先路由分类查询，简单问题用提示链，复杂问题用编排者-工作者，全程通过评估者-优化者保证质量
...
「在LLM领域，最成功的实现不是构建最复杂的系统，而是为特定需求构建_**最合适**_的系统。」首先从简单的提示词开始，通过全面评估进行优化，仅在简单解决方案不足时才添加更多步骤的类Agent系统。
...
3. **精心设计工具接口：**通过详细的工具文档和充分的测试创建良好的Agent-计算机接口（ACI）
...
在实际实现中，AI智能体能够仅基于拉取请求描述解决[SWE-bench Verified](https://www.anthropic.com/research/swe-bench-sonnet)基准测试中的真实GitHub问题，展示了在结构化问题解决中的实际能力。
...
|---|---|
|**操作类型**|**可选表达方式**|
|文件编辑|• 差异(diff)格式<br><br>• 整文件重写|
|结构化输出|• Markdown代码块<br><br>• JSON格式|
...
在[SWE-bench](https://www.anthropic.com/research/swe-bench-sonnet)Agent开发中，工具优化占用了大量精力：
...
> _在为__[SWE-bench](https://www.anthropic.com/research/swe-bench-sonnet)__构建我们的Agent时，__**我们实际上花了更多的时间优化我们的工具，而不是整体提示词**__。_
...
这篇文章更偏向于"器、术、法、道"的"术"，后面将会针对"器"的层面，梳理总结"Agent技术栈"中的开发平台与工具，发布《Agent技术栈全景图》系列，敬请期待！

  

# 推荐阅读

waytoagi热门文章（阅读8000+）：[《从模糊到具体：高效使用DeepSeek-R1等推理型模型的前置步骤》](https://waytoagi.feishu.cn/wiki/KRtwwVqKKiB7PKkgzu3chsX6nzF)

一份普适性提示词模板与智能体：帮助您优化问题定义和答案要求，提升推理型大模型的应用效果，解决AI Agent工具使用的关键问题。

  

# 尾声

技术的力量在于分享，希望这篇总结能成为他人开发之路上的指南针。如果您希望持续获取工作流、Agent技术及大模型应用的最新动态和深度解析，欢迎关注我的公众号[晏明AI](https://mp.weixin.qq.com/s/tdOV-j07jqcyaSJGaLbukA)。智能体的未来已来，这不仅是去发现，更是去创造。期待与更多志同道合的朋友们共同探索AI的无限可能。

![[_resources/‌​⁤⁡⁤‬‬​⁢​‍‍​‬⁡​​‬​⁡⁡⁡﻿​‬​⁣‍⁢⁢​⁢⁣⁤⁡​﻿⁢⁡⁤⁣⁡⁤⁣​⁤⁣​⁣‬工作流与Agent实战指南：从选型决策到高效实施 - 飞书云文档/dd6b4b02b4cb51cf7c4adafba936e1fc_MD5.jpg]]

**感谢你能耐心读到这里！如果这篇文章对你有帮助，欢迎「点赞」支持。也期待你的「收藏」和「分享」，让更多人看到。期待与你在下一篇文章相遇！**