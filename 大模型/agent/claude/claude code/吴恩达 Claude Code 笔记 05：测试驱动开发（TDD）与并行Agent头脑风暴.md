---
标题: "吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴"
链接: "https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491519&idx=2&sn=8e618afe8bfcb3a1cafb3d5d5fd49737&scene=21&poc_token=HHLQrmijdNIo-zIo8jg9ZdytZRvkkFQohyBJmxQ7"
作者: "[[南川同学]]"
创建时间: 2025-08-27T17:31:51+08:00
摘要: "本文介绍了吴恩达Claude Code教程第五期内容，重点讲解测试驱动调试(TDD)和并行Agent头脑风暴在代码重构中的应用。"
tags:
  - "clippings"
  - "AI"
  - "编程"
...
# 内容
#flashcards
原创 南川同学 *2025年08月19日 22:53*

欢迎来到手工川的《吴恩达 x Anthropic：Claude Code 教程 · 第五期 <sup><span>[1]</span></sup> 》学习笔记。
...
我们之前的笔记里提及了 claude code 官方最佳实践的几种范式 <sup><span>[2]</span></sup> ，其中前几节课里 Elie 老师主要采用了第一种 **Explore, plan, code, commit** ，这在初始化项目、新增一个功能时非常有效。
...
有意思的是， [前两天我们的 Vibe Seminar](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491392&idx=2&sn=e747d3ce28681417c946e5be3ac588ad&scene=21#wechat_redirect) 上 Weiyang 也分享了一套自己在研发的 MBTI Agent 系统，他可以让 16 个 MBTI 自动组队完成任务，非常有意思，大家感兴趣也可以了解一下，代码开源在： *https://github.com/weiyangzen/mbti-coding-agents <sup><span>[3]</span></sup>* 。
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/db29fe223431b607e4697accacc707aa_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/199f822499ee6c480986a11a3713a4dd_MD5.webp]]

教程截图：think a lot + plan mode
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/1e1988cd7aa8250f5e8de513616f4374_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/fb69fa261fd7e7ae56ed6afb2b61b48b_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/91fe9610fea43b377b62f5992a8a3c3a_MD5.webp]]
```markdown
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/5ecb0ac7208df2bd567307a9d7b2978b_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/afbf859d7750f64b38da94c3ad3aefba_MD5.webp]]

教程截图：两个Agent输出了各自的方案，供用户选择
...
![[_resources/吴恩达 Claude Code 笔记 05：测试驱动开发（TDD）与并行Agent头脑风暴/d7c0ec6acc72eeaff5f0ab1669d8bb12_MD5.webp]]
...
\[1\] 吴恩达 x Anthropic：Claude Code 教程 · 第五期, https://learn.deeplearning.ai/courses/claude-code-a-highly-agentic-coding-assistant/lesson/33kzc/testing,-error-debugging-and-code-refactoring

\[2\] claude code 官方最佳实践的几种范式, https://www.anthropic.com/engineering/claude-code-best-practices

\[3\] https://github.com/weiyangzen/mbti-coding-agents, https://github.com/weiyangzen/mbti-coding-agents
