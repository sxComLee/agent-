---
标题: "吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化"
链接: "https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491611&idx=1&sn=e2b924e54acf7f3a15590c5f4d8f9447&scene=21&poc_token=HJrQrmijlwg0mG_Tl91KghJWFj8rXNAWOGr1VceU"
作者: "[[南川同学]]"
创建时间: 2025-08-27T17:32:30+08:00
摘要: "本文介绍了如何将Claude Code与GitHub集成实现自动化代码审查和问题修复，并探索其Hooks系统实现开发全流程自动化。"
tags:
  - "clippings"
  - "AI"
  - "编程"
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/85e484c035a0c77765bf65d03c2f997a_MD5.webp]]

source: https://github.com/MarkShawn2020，欢迎follow~

我印象很深刻的是，前几年我经常使用的一个开源库 wechaty，其技术负责人卓桓兄很早就引入了 ai bot，帮助 review 大家的 issue，后面又引入到了他们的 discord 社区。

![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/9abfd37976b8686acdc359f48b732db9_MD5.webp]]
...
至于第二个 part 的 claude code hooks，这也是一个非常有用的功能，在我们的手工川自研插件 ccm(claude-code-manager) <sup><span>[1]</span></sup> 里很早地就支持了 post-tool-use hook，以支持实时的 token 统计。

![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/9d951d15033fd443639c86910b82b106_MD5.webp]]

ccm 中关于post-tool-use的一些代码

btw，昨天学完 [第六期（CC + git worktrees）](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491573&idx=1&sn=0d4c90e32b674ee6c18ae47043e294fb&scene=21#wechat_redirect) 教程后，觉得非常有用，所以当天晚上就兴奋地集成到了 ccm 里，大家可以尝试体验。
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/e43eb6d1e2efaeaf1ee89340a9564762_MD5.webp]]

会话列表

我们让 Claude 清理了 `.trees` 文件夹和相关的 Git 分支，然后将所有合并后的代码推送到了 GitHub 远程仓库。至此，本地的工作告一段落，我们的舞台正式转向云端。

![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/271dbf0035c6a294a0b0b78df3f3181f_MD5.webp]]

推送 github

## 02迎接新队友：集成 Claude Code GitHub App
...
BASH
```
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/2e7730e8832118eaaa5ab701204ff847_MD5.webp]]

/install-github-app

这个命令会引导我们完成一系列的授权流程，包括 GitHub CLI 的认证和 Claude 服务的授权。

![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/9878cdd59cb8f2983c3111fa7b4a72b8_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/b9dc0150be9ab226d2a257e2550fe568_MD5.webp]]

claude bot 在 github 上正在 review 代码
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/f1c6705197a90aa1899f601e75d4e5c7_MD5.webp]]

可以直接在 github issue 里 @claude 安排肝活

这触发了 `claude.yml` 工作流。在 GitHub Actions 的日志中，我们可以看到一个熟悉的场景：Claude Code 开始了它的思考和规划过程，生成了一个 To-do list，这和我们在本地终端中看到的行为完全一致。

![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/2dbbbea732e23d42b4e48cf059de1e1e_MD5.webp]]

claude bot 在github上肝活和日常一样，也会有todo list
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/eb2e2f7c784d52dc01d4f4c39462a22c_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/d6b95e08d1fd73ec80f41ff50a17612c_MD5.webp]]

claude code cook 机制图解
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/5d0f49899df8ea9b0ee6d67ebfb96413_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/0640bbab17c3375ded9b9db5b0fed5c1_MD5.webp]]

在post-tool hook里实现电脑播报
...
![[_resources/吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化/d49a22a295829e7f5649c8ac7d8a9483_MD5.webp]]
...
\[1\] ccm(claude-code-manager), https://github.com/markshawn2020/claude-code-manager
