...
链接: "https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491720&idx=1&sn=a2867ca124e835fd6aebc298c8a55cd4&scene=21&poc_token=HOXQrmijbfNxMKphPy9jU1Zkw1il5mzOjuQeX1Ow"
作者: "[[南川同学]]"
创建时间: 2025-08-27T17:33:40+08:00
摘要: "本文介绍了如何使用Claude Code结合Figma MCP从设计稿直接生成功能完备的Next.js全栈应用，展示了AI辅助开发从设计到代码的完整工作流。"
tags:
  - "clippings"
  - "AI"
  - "编程"
...
![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/27c570ee33a38d23104ba2f22480e6e6_MD5.webp]]
...
```
![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/5dae6880487857edc020a9315476f400_MD5.webp]]
...
3. **连接 Playwright (手/验证工具)** ：我们同样使用 `claude mcp add` 命令，添加 Playwright MCP Server。
![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/698353be27f8c137eaeb0d980ee65a27_MD5.webp]]

项目增加 figma mcp

配置完成后，我们可以在 Claude Code 中使用 `/mcp` 命令，检查两个服务器是否都已成功连接。

![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/ebfc6a7e958a9984459996652d1b210c_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/e615aa520030d5fad71f79dade68ecf1_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/43011a835f629ab2293d7b1f807e0617_MD5.webp]]

cc 已经复刻了目标 figma（甚至效果更好）

## 03从静态 UI 到动态应用的“灵魂注入”
...
![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/3e829cb3c0ddfc3378a9bf7ab67db155_MD5.webp]]

确认 Fred API Key

这个过程完美地模拟了一个人类工程师的工作流程：接到需求 -> 查阅资料 -> 发现前置条件 -> 请求资源 -> 编写代码 -> 集成调试。

![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/d0aacc05638da1baf0d5695c15c64c6e_MD5.webp]]
...
感谢 **Elie Schoppik** 老师的精彩讲解，也感谢各位读者的一路相伴。虽然课程解读到此结束，但 AI 辅助开发的探索之旅，才刚刚开始。在接下来的文章中，我将脱离课程本身，分享我的 **Claude Code 个人最佳实践** ，以及本系列教程 **AI** **搬运工作流** ，敬请期待!

![[_resources/吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App/eafa1f372836252601206de36b4af422_MD5.webp]]
...
- 本期课程最终完成的 FRED 仪表盘应用，其完整的 Next.js 源代码都可以在这里找到，是学习和参考的绝佳范例。
	- https://github.com/https-deeplearning-ai/FRED-dashboard <sup><span>[1]</span></sup>
...
- DeepLearning.AI 官方提供的、涵盖 **本系列所有课程** 的配套文件、数据和完整的 Prompt 文本。如果你想 1:1 复现课程中的任何一个环节，这里是你的“宝库”。
	- https://github.com/https-deeplearning-ai/sc-claude-code-files <sup><span>[2]</span></sup>
- 观看原版视频课程，体验 Elie Schoppik 老师的亲自教学。
	- https://learn.deeplearning.ai/courses/claude-code-a-highly-agentic-coding-assistant <sup><span>[3]</span></sup>
...
- **第二阶段：数据注入**
	...
	populate these charts with real-world data from FRED
	```
- *注意：执行此 Prompt 前，请先前往 FRED 官网 <sup><span>[4]</span></sup> 申请你自己的 API Key。*
...
\[4\] FRED 官网, https://fred.stlouisfed.org/docs/api/api\_key.html
