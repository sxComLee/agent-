---
标题: "吴恩达 Claude Code 笔记精华版"
链接: "https://mp.weixin.qq.com/s/Of1qAQuAQDrkyWIZ0ug-dw?from=singlemessage&scene=1&subscene=317&clicktime=1756272428&enterid=1756272428&click_id=37"
作者: "[[南川同学]]"
创建时间: 2025-08-27T17:28:26+08:00
摘要: "本文是吴恩达与Anthropic合作课程《Claude Code: A Highly Agentic Coding Assistant》的精华总结版，系统介绍了从入门到进阶的Claude Code使用方法和最佳实践。"
tags:
  - "clippings"
  - "AI"
  - "编程"
...
# 内容
#flashcards
原创 南川同学 *2025年08月24日 22:36*

在过去两周，我们已经逐期整理了 **吴恩达与 Anthropic 在线教育主管 Elie Schoppik** 的合作课程《Claude Code: A Highly Agentic Coding Assistant》 <sup><span>[1]</span></sup> 的全部内容，总共九期并收录在 [《吴恩达 Claude Code 笔记合集》](https://mp.weixin.qq.com/mp/appmsgalbum?__biz=Mzg2OTg5NDg3Mg==&action=getalbum&album_id=4121229896725266445#wechat_redirect) ：

- [01\. 引言](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491212&idx=1&sn=6adfd290d89286bc8cb1f005ae2b5217&scene=21#wechat_redirect)
- [02\. 揭秘 AI 编程助理的核心机制](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491230&idx=1&sn=474aa770e1f31cdc7800767e08200885&scene=21#wechat_redirect)
- [03\. 深入代码库与 AI 记忆的构建](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491314&idx=1&sn=1c35f42d0e7943eefd861426bcd733c9&scene=21#wechat_redirect)
- [04\. Prompt范式、深度思考、上下文工程与MCP](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491392&idx=1&sn=55b32bc2a95401d12d3001c17b9c292d&scene=21#wechat_redirect)
- [05\. 测试驱动开发（TDD）与并行Agent头脑风暴](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491519&idx=2&sn=8e618afe8bfcb3a1cafb3d5d5fd49737&scene=21#wechat_redirect)
- [06\. CC + Git Worktree = 王炸](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491573&idx=1&sn=0d4c90e32b674ee6c18ae47043e294fb&scene=21#wechat_redirect)
- [07\. 集成 GitHub 与 Hooks 实现开发全流程自动化](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491611&idx=1&sn=e2b924e54acf7f3a15590c5f4d8f9447&scene=21#wechat_redirect)
- [08\. Jupyter 数据分析与 Streamlit 可视化](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491692&idx=1&sn=ad5b9fc04ec86db8c12a0667624f617d&scene=21#wechat_redirect)
- [09\. 基于 Figma MCP 直出 App](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491720&idx=1&sn=a2867ca124e835fd6aebc298c8a55cd4&scene=21#wechat_redirect)

如果您也有类似高质量的教程、文章资源，欢迎留言区推荐，我们一起学习，一起进步~

今天是精华总结版特刊，旨在提供一个速览，并针对不同人群提供尽可能全面的学习路线指导。

![[_resources/吴恩达 Claude Code 笔记精华版/2e05bdfd0e59d4300c541048edbbae61_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记精华版/bc00d982f80f6317a750fc5673837512_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记精华版/0cb147e398a863623eee90d9781250e5_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 笔记精华版/ea1e6df21de146fb389ceefeaa465d69_MD5.webp]]
...
> 手工川注：TDD 只是众多开发范式中的一种，还有以 Kiro <sup><span>[2]</span></sup> 为代表的 Spec 驱动，以及最近比较火的 pilot驱动（去年就有一个gpt-pilot也火过一次），各有各的用处。参考：
> 
> - AWS Kiro 发布：AI 赋能的 agentic IDE，开启“spec 驱动开发”新时代 <sup><span>[3]</span></sup>
> - [字节新出的「PromptPilot」太好用了！！](https://mp.weixin.qq.com/s?__biz=MzI4MjUyNTg1OQ==&mid=2247559008&idx=1&sn=3f1c94bf733be1e7d72312cb6abc9289&scene=21#wechat_redirect)
...
![[_resources/吴恩达 Claude Code 笔记精华版/5ecb0ac7208df2bd567307a9d7b2978b_MD5.webp]]

教程截图：两个agent在并行地执行任务
...
> 手工川注：git worktree会强迫cc在非当前目录运行，导致 @的智能补全失效、merge维护成本变高等，更加适合团队开发使用，每个人独立开启worktree，互不干扰，然后组长决定是否合并。手工川一直维护的 claude code 增强工具 ccm <sup><span>[4]</span></sup> 最近也上线了 worktree 开发模式，欢迎大家体验与反馈。
...
cc创建了workflow，workflow里约定了一些特定场景（例如被at），触发后自动读取仓库并实现需求，参考：https://github.com/MarkShawn2020/claude-code-manager/blob/main/.github/workflows/claude.yml <sup><span>[5]</span></sup>

---

参考： [吴恩达 Claude Code 笔记 07：集成 GitHub 与 Hooks 实现开发全流程自动化](https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491611&idx=1&sn=e2b924e54acf7f3a15590c5f4d8f9447&scene=21#wechat_redirect)
...
1. **快速上手** ：从 Quickstart <sup><span>[6]</span></sup> 开始，熟悉基本的交互模式。
...
3. **企业级部署与治理** ：研究第三方集成方案 <sup><span>[7]</span></sup> ，如通过 Amazon Bedrock 或 Google Vertex AI 进行部署，配置企业代理和 LLM 网关。
4. **安全与监控** ：精通 IAM <sup><span>[8]</span></sup> 和企业级策略配置，利用 OpenTelemetry <sup><span>[9]</span></sup> 进行全面的使用情况监控、成本分析和安全审计。
...
> 吴恩达老师的教程通俗易懂，学习曲线较为平缓，犹记得几年前学习他的机器学习教程，快结束的时候非常感动，印象深刻，推荐大家对计算机、AI感兴趣的可以多去 https://www.deeplearning.ai/ <sup><span>[10]</span></sup> 网站逛逛~
...
\[1\] 《Claude Code: A Highly Agentic Coding Assistant》, https://www.deeplearning.ai/short-courses/claude-code-a-highly-agentic-coding-assistant

\[2\] Kiro, https://kiro.dev/

\[3\] AWS Kiro 发布：AI 赋能的 agentic IDE，开启“spec 驱动开发”新时代, https://www.hkn.today/p/aws-kiro-ai-agentic-idespec

\[4\] claude code 增强工具 ccm, https://github.com/MarkShawn2020/claude-code-manager

\[5\] https://github.com/MarkShawn2020/claude-code-manager/blob/main/.github/workflows/claude.yml, https://github.com/MarkShawn2020/claude-code-manager/blob/main/.github/workflows/claude.yml

\[6\] Quickstart, https://docs.anthropic.com/en/docs/claude-code/quickstart

\[7\] 第三方集成方案, https://docs.anthropic.com/en/docs/claude-code/third-party-integrations

\[8\] IAM, https://docs.anthropic.com/en/docs/claude-code/iam

\[9\] OpenTelemetry, https://docs.anthropic.com/en/docs/claude-code/monitoring-usage

\[10\] https://www.deeplearning.ai/, https://www.deeplearning.ai/

  

微信：Youshouldspeakhow
