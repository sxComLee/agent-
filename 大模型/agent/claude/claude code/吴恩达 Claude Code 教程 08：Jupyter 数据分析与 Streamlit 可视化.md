---
标题: "吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化"
链接: "https://mp.weixin.qq.com/s?__biz=Mzg2OTg5NDg3Mg==&mid=2247491692&idx=1&sn=ad5b9fc04ec86db8c12a0667624f617d&scene=21&poc_token=HL7QrmijZznML3jQtqbXn3rnPSAFqVwvQr7pod2l"
作者: "[[南川同学]]"
创建时间: 2025-08-27T17:33:03+08:00
摘要: "本文介绍了如何使用Claude Code将杂乱的Jupyter Notebook数据分析代码重构为模块化工程代码，并进一步转化为Streamlit交互式仪表盘。"
tags:
  - "clippings"
  - "AI"
  - "编程"
...
![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/6572e166dd7ed5117b88cbdb63391bd8_MD5.webp]]

这个领域还有一本必读书《利用python进行数据分析》 <sup><span>[1]</span></sup> ，教大家如何使用数据分析三大件：numpy、pandas、matplotlib。我当时学的是第二版，现在都已经第三版了（不过译者是我好朋友，欢迎大家多多支持，hhh：）

![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/48ae524ba072c4d002ccbae74e0fbee0_MD5.webp]]

如果你不想买纸质书的话，也可以访问这里查看电子版 <sup><span>[2]</span></sup> （当然了，作者还是我的好朋友，欢迎大家多多支持，hhh：）

![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/39fd9bdc9e266b4e9ce4d4e0e7af3f0b_MD5.webp]]
...
![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/91e2ee358955a2d304c7677f4204442b_MD5.webp]]

## 01场景复现：一份典型的“混乱”Notebook

课程从一个常见的数据分析场景开始：我们拿到了一份分析电商数据的 Jupyter Notebook。

![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/e58486ccf220a773ec65e2e9b906932b_MD5.webp]]

vscode / jupyter-notebook / pandas / CSV
...
![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/d6db7e1ea5b82c082afb1f4a741864a2_MD5.webp]]

尝试使用 cc 优化可视化

## 02第一步：从 Notebook 到模块化代码的重构

我们启动 Claude Code，并准备了一个详尽的 Prompt。值得一提的是，为了处理复杂的指令，一个很好的实践是先将 Prompt 写在一个 Markdown 文件中，这样便于组织思路和反复修改。

![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/5f8064cccdb0f6ae63b6296d3b21d2a6_MD5.webp]]

直接把 prompt 写成 md 文件形式
...
![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/0d800c57e078b0ff7d022de1f1449bc4_MD5.webp]]

在重构过程中，我们遇到了一个 `KeyError` 。这提供了一个很好的机会来展示人机协作调试的流程：我们将错误信息和相关的代码单元格反馈给 Claude Code，它迅速定位问题并进行了修复。

![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/a1992c4e16de8740a3f7d51fc9e701da_MD5.webp]]

cc 正在实现需求

最终，我们得到了一套结构清晰的代码。新的 Notebook 变得非常整洁，主要由导入语句、高层函数调用和精美的图表组成，可读性和可维护性得到了质的飞跃。

## 03第二步：从 Notebook 到 Streamlit 仪表盘的跃迁
...
![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/2665c7c54a2c093befa7b754c6dd1e77_MD5.webp]]

prompt：ipynb --> streamlit
...
![[_resources/吴恩达 Claude Code 教程 08：Jupyter 数据分析与 Streamlit 可视化/984758908bda3862b6c384d79d79431a_MD5.webp]]
...
\[1\] 《利用python进行数据分析》, https://search.douban.com/book/subject\_search?search\_text=%E5%88%A9%E7%94%A8python%E8%BF%9B%E8%A1%8C%E6%95%B0%E6%8D%AE%E5%88%86%E6%9E%90&cat=1001

\[2\] 电子版, https://github.com/iamseancheney/python\_for\_data\_analysis\_2nd\_chinese\_version

\[3\] https://github.com/gradio-app/gradio, https://github.com/gradio-app/gradio

\[4\] https://github.com/streamlit/streamlit, https://github.com/streamlit/streamlit
